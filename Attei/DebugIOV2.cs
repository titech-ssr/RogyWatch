...
namespace Attei.PCL
{
    public partial class V2
    {
        ...
        {
            StreamWriter sw = new StreamWriter("C:\\Users\\Maquinista\\Desktop\\hisui-1_13_0_0-20110927\\bin\\V2\\" + dateTitle + "data.asc");
        ...
        private static void BMPDraw(string date, List<Vector3D> points)
        {
            int __y = 0;
            int __x = 0;
            try
            {
                string tempPath = "C:\\template_V2.bmp";
                ...
                using (var ms_to_byte = new MemoryStream())
                {
                    ...
                    using (var ms_to_bmp = new MemoryStream(output))
                    {
                        ...
                        bmp2.Save($"C:\\V2_png\\{date}.png", ImageFormat.Png);
                    }
                }
            }
            catch(Exception ex)
